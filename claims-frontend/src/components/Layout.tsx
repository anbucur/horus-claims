      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <header className="h-12 bg-surface-panel border-b border-slate-200 flex items-center px-4 gap-4 shrink-0">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-xs text-slate-600">Core System Connected</span>
          </div>
          <div className="h-6 w-6 rounded-full bg-brand-secondary flex items-center justify-center text-white text-xs font-medium">
            A
          </div>
        </header>
